...
const About = () => {
    ...
    return (
        <Col className="about-page" style={{marginTop: '70px', paddingRight: '12px', marginLeft: '0px', height: '100%'}}>
            ...
            {/* <Row className='about-card' style={{marginRight: '10%', marginLeft: '10%', marginBottom: '40px'}}>
                <div className='howToListItem' style={{marginBottom: '10px', paddingRight: '5%', paddingLeft: '5%'}}>
                    <h4 style={{marginTop: '10px'}}><a href="https://forum.earthdata.nasa.gov/viewforum.php?f=7&tagMatch=all&DAAC=146&keywords=&sid=970ecb7a5612cbf44f6d7c1525019147" target="_">EarthData Forum for SWODLR</a></h4>
                </div>
            </Row> */}
            ...
            <Row className='about-card' style={{marginRight: '10%', marginLeft: '10%', marginBottom: '40px'}}>
                <div className='howToListItem' style={{marginBottom: '20px', paddingRight: '5%', paddingLeft: '5%'}}>
                    ...
                    <ListGroup>
                        {/* <ListGroup.Item className='howToListItem' style={{marginRight: '0%', marginLeft: '0%'}}>
                            <Row><h5><b>Tool Development Team</b></h5></Row>
                        </ListGroup.Item> */}
                        <ListGroup.Item className='howToListItem' style={{marginRight: '0%', marginLeft: '0%'}}>
